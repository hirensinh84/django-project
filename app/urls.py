...
from .views import home,login,registration,contact,about,product,reset_password_view,forget,logout_view,myprofile_view,oldpass_view,product_detail,product,add_to_cart,remove_cart_item,decrease_quantity,increase_quantity,view_cart,checkout_view,address_view,delete_address,payment_succes_view,order_detail_view,otp_verify_view,resend_otp_view
...
urlpatterns = [
    ...
    path('category/<int:id>/', product, name='category_products'), 
